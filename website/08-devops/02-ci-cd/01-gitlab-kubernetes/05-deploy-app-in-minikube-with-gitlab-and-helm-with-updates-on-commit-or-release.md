...
permalink: /devops/ci-cd/gitlab-kubernetes/deploy-app-in-minikube-with-gitlab-and-helm-with-updates-on-commit-or-release/
---
...
![Application](/img/devops/ci-cd/gitlab-kubernetes/pic-lecture03-pic01.png?raw=true)
