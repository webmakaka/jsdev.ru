...
С помощью библиотеки lodash, можно упростить работу и улучшить понимание и восприятия кода. О чем собственно он и рассказывает на примерах на протяжении всего курса.
...
Достаточно интересный курс. Начал смотреть. Пока смотрю первую часть. Исходные коды есть.

И TypeScript, и GraphQL, и React, и MongoDB присутствуют.
