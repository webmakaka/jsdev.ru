...
Подключив локальный GitLab (уже отработано, если будет нужно распишу), можно сделать автоматическую сборку и deploy по коммиту или релизу на тестовый или боевой сервер kubernetes.
