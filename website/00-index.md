...
Сам записался в школу.

Прошел курс по node.js. Прохожу по Node.js + aws. Кому интересно, можно будет запланировать свое обучение на следующий поток. Например, курс Node.js + AWS планируют читать 2 раза в год.
